      ...
      <section className=" z-10 pt-16 pb-8 sm:pb-0 sm:pt-0 overflow-hidden h-[130vh] lg:h-[120vh] border border-black  dar dark:bg-dark py-4 sm:py-20 lg:py-[120px] relative contect-img ">
        ...
        <div className="container mx-auto">
          <div className="flex flex-wrap  mt-5 sm:mt-28">
            <div className="lg:hidden flex flex-col sm: pt-10 ml-5 sm: text-5xl sm: font-bold sm: mb-0  font-sans shadow-xlg  ">
              <span style={{opacity:1}} className="text-white  flex flex-row items-center  space-x-4 ">
                ...
                <a
                  ...
                  className="text-gray-300 hover:text-white"
                >
                  <FaMailBulk size={30} /> {/* Facebook icon */}
                </a>
              </span>
