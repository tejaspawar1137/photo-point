...
const NavBar = () => {
  ...
  return (
    <div>
      ...
      {
        loading?(<Loader></Loader>):(      <nav className="relative px-4 py-4 flex sm: justify-between items-center bg-white ">
        <a className="text-3xl font-bold leading-none" href="/">
        <p className="text-2xl font-bold text-black font-sans">Dheeraj Studio</p>
